# რანდომ გენერირებული სიის დალაგება ზრდადობით
import random
...
# რანდომ გენერირებული ლისთის დალაგება კლებადობით
import random
...
# კოდი ადარებს ბაბლ და სელექშენ სორთს ერთმანეთს სხვადასხვა რაოდენობით დათაზე
import random
import time
